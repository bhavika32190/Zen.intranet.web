...
namespace Zen.intranet.web.Controllers
{
    public class ZnsEmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Firstname,FieldExperience,Salary,DOb")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Firstname,FieldExperience,Salary,DOb")] Employee employee)
        {
            if (ModelState.IsValid)
            {
